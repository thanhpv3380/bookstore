		...
		<table class="table table-hover table-bordered">
			<thead>
				<tr>
					...
					<th><a href="AddPublisherController" class="btn btn-info">Add</a></th>
				</tr>
			</thead>
			<tbody>
				...
				<c:forEach items="${listPublisher}" var="lPublisher">
					...
					<tr>
						<td>${lPublisher.id_publisher}</td>

						<td>${lPublisher.name}</td>
						<td><a
							href="EditPublisherController?idPublisher=${lPublisher.id_publisher}" class="btn btn-warning">Edit</a> -
							<a
							href="DeleteController?name=publisher&id=${lPublisher.id_publisher}" class="btn btn-danger">Delete</a>
