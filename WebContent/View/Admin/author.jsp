		...
		<table class="table table-hover table-bordered">
			<thead>
				<tr>
					<th>id</th>
					<th>Name Author</th>
					<th><a href="AddAuthorController" class="btn btn-info">Add</a></th>
				</tr>
			</thead>
			<tbody>

				<c:forEach items="${listAuthor}" var="lAuthor">

					<tr>
						<td>${lAuthor.id_author}</td>
	
						<td>${lAuthor.name}</td>
						<td><a href="EditAuthorController?idAuthor=${lAuthor.id_author}" class="btn btn-warning">Edit</a> -
						<a href="DeleteController?name=author&id=${lAuthor.id_author}" class="btn btn-danger">Delete</a>
